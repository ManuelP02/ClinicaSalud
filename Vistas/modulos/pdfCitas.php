...
$sql = "SELECT c.id_doctor, c.id_consultorio, c.documento, c.nyaP, d.nombre AS doctornombre, d.apellido AS doctorapellido, nombreconsultorio, inicio, fin
    ...
    INNER JOIN consultorios as con ON c.id_consultorio=con.idconsultorio ORDER BY inicio ASC";
    ...
    $pdf->AddPage();
     $datos = $resultado->fetch_assoc();
            $pdf->AliasNbPages();
      $pdf->SetTitle("Todas las citas");
      $pdf->SetFont("Arial", "B", 20);
    $pdf->Cell(290, 0, 'Todas las citas', 0, 1, "C");
    $pdf->Ln(5);
