<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Iniciar sesión como doctor</p>
    ...
    <form method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat" style="font-size: 17px;">Iniciar sesión</button>
           </form>
        </div>
        <!-- /.col -->
      </div>
