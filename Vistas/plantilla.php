...
<?php
    ...
    }else if($_SESSION["rol"] == "Administrador" && $_GET["url"] != "pdfCons" && $_GET["url"] != "docPdf" && $_GET["url"] != "consPdf" && $_GET["url"] != "consCitasPdf" && $_GET["url"] != "docCitasPdf" && $_GET["url"] != "pdfCitas" && $_GET["url"] != "pdfRecCons" && $_GET["url"] != "consRecetasPdf" && $_GET["url"] != "docRecetasPdf" && $_GET["url"] != "pdfRecSum"){
