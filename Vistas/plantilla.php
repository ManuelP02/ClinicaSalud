...
<?php
    ...
    }else if($_SESSION["rol"] == "Administrador" && $_GET["url"] != "pdfCons" && $_GET["url"] != "docPdf" && $_GET["url"] != "consPdf" && $_GET["url"] != "consCitasPdf" && $_GET["url"] != "docCitasPdf" && $_GET["url"] != "pdfCitas" && $_GET["url"] != "pdfRecCons" && $_GET["url"] != "consRecetasPdf" && $_GET["url"] != "docRecetasPdf" && $_GET["url"] != "pdfRecSum" && $_GET["url"] != "pdfCitasSum" && $_GET["url"] != "pdfServSum"){
    ...
    if(isset($_GET["url"])){
      ...
      if($url[0] == "inicio" || $url[0] == "salir" || $url[0] == "perfil-Secretaria" || $url[0] == "perfil-S"   || $url[0] == "consultorios"  || $url[0] == "E-C" || $url[0] == "E-S" || $url[0] == "servicios" || $url[0] == "doctores" || $url[0] == "pacientes" || $url[0] == "atencion" || $url[0] == "perfil-Paciente" || $url[0] == "perfil-P" || $url[0] == "Ver-consultorios" || $url[0] == "Doctor" || $url[0] == "historial" || $url[0] == "CrearAtencion" || $url[0] == "historialclinico" || $url[0] == "CrearReceta" || $url[0] == "perfil-Doctor" || $url[0] == "perfil-D" || $url[0] == "Citas"|| $url[0] == "perfil-Administrador" || $url[0] == "perfil-A" || $url[0] == "pdfhist" || $url[0] == "secretarias" || $url[0] == "inicio-editar" || $url[0] == "historialpacient" || $url[0] == "Recetas" || $url[0] == "VerReceta" || $url[0] == "pdfrec" || $url[0] == "GestRecet" || $url[0] == "borrarCita.php" || $url[0] == "repCons" || $url[0] == "pdfCons" || $url[0] == "repDoct" || $url[0] == "docPdf" || $url[0] == "pdfserv"  || $url[0] == "consPdf" || $url[0] == "historialdoctor" || $url[0] == "repCitasCons" || $url[0] == "repCitasDoct" || $url[0] == "consCitasPdf" || $url[0] == "docCitasPdf" || $url[0] == "pdfCitas"  || $url[0] == "pdfRecCons" || $url[0] == "repRecetasCons" || $url[0] == "consRecetasPdf" || $url[0] == "repRecetasDoct" || $url[0] == "docRecetasPdf" || $url[0] == "pdfRecSum" || $url[0] == "pdfCitasSum" || $url[0] == "pdfServSum"){
