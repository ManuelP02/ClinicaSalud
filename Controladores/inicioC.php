	...
	public function EditarInicioC(){
		...
		echo '				<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<h2>Introducción:</h2>
					<input type="text" class="input-lg" name="intro" size="145" value="'.$resultado["intro"].'">
					...
					<h2>Dirección:</h2>
					<input type="text" class="input-lg" name="direccion" size="36" value="'.$resultado["direccion"].'">
