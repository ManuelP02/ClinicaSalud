...
///Funcion para iniciar sesion en secretaria
	public function IngresarSecretariaC(){

		if(isset($_POST["usuario-Ing"])){
///Aqui estan listados los caracteres que se aceptaran para el ingreso de los usuarios y contraseña de las secretarias
 ...
 ///Funcion para ver el perfil de las secretarias
